...
- [x] Оптимизация уведомлений при автоматической настройке выполнения задач [Низкий] Время: 10мин Очередь: 2
...
- [ ] Исправить некорректную работу drag-and-drop при перемещении задач в "ОЧЕРЕДЬ ЗАДАЧ" [Низкий] Время: 10мин Очередь: 1
