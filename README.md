...
- **JSON файл** (`.task_flow_state.json`) - источник правды для расширения
- **Markdown файл** (`task_flow_tasks.md`) - автоматически генерируемое человекочитаемое представление
...
| Команда                                  | Описание                                                    |
| ---------------------------------------- | ----------------------------------------------------------- |
| `TaskFlow: Инициализировать задачи`      | Создать файл задач в .github/task_flow_tasks.md             |
...
```json
{
  "taskflow.tasksFile": ".github/task_flow_tasks.md",
